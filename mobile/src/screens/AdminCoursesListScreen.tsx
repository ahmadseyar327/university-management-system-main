...
type Props = BottomTabScreenProps<AdminTabParamList, "AdminCourses">;
      ...
      renderItem={({ item }) => (
        <View style={styles.card}>
          ...
          <Text style={styles.meta}>
            {String(item.code)} · {String(item.type)} · {String(item.creditHours)} cr · fee {String(item.fee)}
          </Text>
...
const styles = StyleSheet.create({
  ...
  meta: { color: "#4a5568", marginTop: 4, fontSize: 14 },
