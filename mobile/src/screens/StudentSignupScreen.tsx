...
export default function StudentSignupScreen({ navigation }: { navigation: Nav }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
      ...
      <Text style={styles.hint}>Same as the web app — you will get a roll number after registration.</Text>
      ...
      <Text style={styles.footer}>
        ...
        <Text style={styles.link} onPress={() => navigation.navigate("StudentLogin")}>
          Sign in
        </Text>
      </Text>
    </ScrollView>
